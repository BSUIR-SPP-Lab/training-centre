...
public class CourseWithInfoView {
    ...
    public CourseWithInfoView(long courseId, long courseInfoId, long coordinatorId, String firstName, String lastName, String start, String end, String name, String description) {
