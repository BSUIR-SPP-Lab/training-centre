CREATE DATABASE  IF NOT EXISTS `training_service_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `training_service_db`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: training_service_db
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `training_service_db`.`group_BEFORE_INSERT` BEFORE INSERT ON `group` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `training_service_db`.`group_BEFORE_UPDATE` BEFORE UPDATE ON `group` FOR EACH ROW
BEGIN
	DECLARE user_count INT;
	SET user_count = (SELECT COUNT(*) FROM `user` WHERE (NEW.`coordinator_id` = `user`.`user_id`) AND (`user`.`role` = 'coordinator'));
	IF user_count != 1 THEN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `training_service_db`.`solution_BEFORE_INSERT` BEFORE INSERT ON `solution` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `training_service_db`.`teacher_BEFORE_INSERT` BEFORE INSERT ON `teacher` FOR EACH ROW
BEGIN
	DECLARE user_count INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `training_service_db`.`teacher_BEFORE_UPDATE` BEFORE UPDATE ON `teacher` FOR EACH ROW
BEGIN
	DECLARE user_count INT;
	SET user_count = (SELECT COUNT(*) FROM `user` WHERE (NEW.`teacher_id` = `user`.`user_id`) AND (`user`.`role` = 'teacher'));
	IF user_count != 1 THEN
...
--
-- Dumping events for database 'training_service_db'
--

--
-- Dumping routines for database 'training_service_db'
--
